...
2. **Database.** Apply `supabase/migrations/0015_stripe.sql`, then `0016_delivery_method.sql`, then `0017_checkout_address.sql`, then `0018_guest_orders.sql` (after `0014`), then `0027_house_prices.sql` (after `0026`), then `0028_house_price_30ml.sql`.
